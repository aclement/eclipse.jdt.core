...
public class TypeAnnotationInfo extends ClassFileStruct implements IBinaryTypeAnnotation {
	...
	// TargetType CLASS_EXTENDS: supertype index (-1 = superclass, 0..N superinterface)
	// TargetType METHOD_TYPE_PARAMETER: type parameter index 
	// TargetType CLASS_TYPE_PARAMETER: type parameter index
	// TargetType CLASS_TYPE_PARAMETER_BOUND: type parameter index
	// TargetType METHOD_FORMAL_PARAMETER: method formal parameter index
	// TargetType THROWS: throws type index
	private int info;
	
	// TargetType CLASS_TYPE_PARAMETER_BOUND: bound index
	private int info2;
